...
open class IncompleteAttackItem(symptomList: RealmList<String> = RealmList("default SL"),
    ...
    override fun toString(): String {
        return "Message: [id=$_id, symptomList=$symptomList, intensityList=$intensityList, startTime=$startTime, note =$note partition=$_partition]"
    }
}
